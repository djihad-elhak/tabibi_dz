...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', 'tabib-tabib-dz1.b.aivencloud.com'),  # Database host (default: localhost)
        'PORT': os.getenv('DB_PORT', '21249'),   
...
ALLOWED_HOSTS = ['tabib.onrender.com', '127.0.0.1', 'localhost']
